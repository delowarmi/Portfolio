...
import aboutPic from "/src/assets/bg-removebg-preview.png"; // Ensure correct path
...
const services = [
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "Creating stunning, user-friendly, and interactive UI designs with Figma, Adobe XD, and modern CSS frameworks.",
    icon: <FaPaintBrush />,
        ...
        <section className="mt-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((project) => (
              <motion.div
                key={project}
                className="p-6 bg-gray-800 rounded-lg relative overflow-hidden"
                whileHover={{ scale: 1.05 }}
              >
                <motion.div
                  className="absolute inset-0 border-4 rounded-lg border-transparent"
                  animate={{
                    borderColor: [
                      "#ff0000",
                      "#00ff00",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            {services.map((service, index) => (
              ...
              >
                ...
                <div
                  className={`relative z-10 text-5xl p-4 rounded-full bg-gradient-to-r ${service.color} text-white`}
                >
                  {service.icon}
                </div>
                <h3 className="relative z-10 text-xl font-semibold mt-4">
                  {service.title}
                </h3>
